...
class PortfolioSelection:
    ...
    @staticmethod
    def generate_possible_portfolios(ranking_metrics,group_percentages,num_of_groups,max_prices,min_prices,max_market_caps,min_market_caps,stoplosses,rolling_windows,leverages):
        """
        ...
        portfolios = []
        for ranking_metric, timeframe, group_percentage, grouping_type, selection_type, allocation_type, risk_type, position_type, num_of_group, max_price, min_price, max_market_cap, min_market_cap,stoploss, rolling_window, leverage in product(
            ranking_metrics, Timeframe, group_percentages, GroupingType, SelectionType, AllocationType, RiskType, PositionType, num_of_groups, max_prices, min_prices, max_market_caps,min_market_caps, stoplosses, rolling_windows, leverages):
